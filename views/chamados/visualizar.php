...
?>
 ...
 <a href="<?php echo base_url(); ?>chamados/adicionar" class="btn btn-success" ><i class="icon-plus icon-white"></i> Adicionar Chamado</a>
...
<div id="modal-excluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url() ?>chamados/excluir" method="post" >
        ...
        <div class="modal-body">
            ...
            <h5 style="text-align: center">Deseja realmente excluir esta Chamado?</h5>
        </div>
