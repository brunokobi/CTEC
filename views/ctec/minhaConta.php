            ...
            <div class="widget-content">
                <div class="row-fluid">
                    <div class="span12" style="min-height: 260px">
                        <ul class="site-stats">
                            <li class="bg_ls span12"><strong>Nome: <?php echo $usuario->nm_usuario?></strong></li>
                            <li class="bg_lb span12" style="margin-left: 0"><strong>Empresa: <?php echo $usuario->ds_empresa?></strong></li>
                            <li class="bg_lg span12" style="margin-left: 0"><strong>Email: <?php echo $usuario->login?></strong></li>
                        </ul>
                    </div>
...
<div class="span6">
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="row-fluid">
                    <div class="span12" style="min-height: 260px">
                        <form id="formSenha" action="<?php echo base_url();?>ctec/alterarSenha" method="post">
